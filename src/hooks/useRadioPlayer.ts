...
import TrackPlayer,
{ Event, State, usePlaybackState, useTrackPlayerEvents } from "react-native-track-player";
...
export function useRadioPlayer() {
    ...
    return {
        track, playbackState, togglePlayback, loading,
        appIsReady, visible, message, setVisible, statePlayer
    };
}